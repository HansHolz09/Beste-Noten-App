...
class IosKeychainCredentialsStorage : CredentialsStorage {
    ...
    override fun setInt(
        key: String,
        value: Int,
    ) = KeychainSettings().putInt(key, value)

    override fun setLong(
        key: String,
        value: Long,
    ) = KeychainSettings().putLong(key, value)

    override fun setBoolean(
        key: String,
        value: Boolean,
    ) = KeychainSettings().putBoolean(key, value)
}

@Suppress("EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING")
actual class CredentialsStorageFactory {
    actual fun create(): CredentialsStorage = IosKeychainCredentialsStorage()
}
