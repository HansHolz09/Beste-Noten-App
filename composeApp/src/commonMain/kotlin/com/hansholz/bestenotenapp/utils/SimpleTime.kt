...
data class SimpleTime(
    ...
    fun plusMinutes(minutes: Long): SimpleTime = fromTotalMinutes(toTotalMinutes() + minutes)

    fun minusMinutes(minutes: Long): SimpleTime = plusMinutes(-minutes)

    operator fun plus(minutes: Int): SimpleTime = plusMinutes(minutes.toLong())
