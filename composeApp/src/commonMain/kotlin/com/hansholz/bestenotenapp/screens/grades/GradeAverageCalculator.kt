...
internal const val CATEGORY_EXAM = 0
internal const val CATEGORY_OTHER = 1
...
internal data class SubjectWeightingConfig(
    ...
    fun categoryFor(typeName: String): Int = typeCategoryOverrides[typeName] ?: defaultCategoryForType(typeName)
...
internal fun defaultSubjectWeightingConfig(useWeightingInsteadOfPercent: Boolean): SubjectWeightingConfig =
...
internal data class SubjectAverageResult(
    val average: Float?,
...
internal fun calculateSubjectAverage(
...
internal fun formatAverageLabel(result: SubjectAverageResult): String {
...
internal fun subjectWeightingKey(
    subjectTitle: String?,
    collections: List<GradeCollection>,
): String {
...
internal fun subjectTypeNames(collections: List<GradeCollection>): List<String> =
    collections
        .map { it.type.trim() }
...
internal fun defaultCategoryForType(typeName: String): Int = if (examTypes.contains(typeName.trim().uppercase())) CATEGORY_EXAM else CATEGORY_OTHER

internal fun loadSubjectWeighting(
    kSafe: KSafe,
    subjectKey: String,
...
internal fun persistSubjectWeighting(
    kSafe: KSafe,
    subjectKey: String,
    weighting: SubjectWeightingConfig,
) {
...
internal fun clearSubjectWeighting(
    kSafe: KSafe,
    subjectKey: String,
...
internal fun convertStoredSubjectWeightingsMode(
    kSafe: KSafe,
    useWeightingInsteadOfPercent: Boolean,
) {
    val store = loadStore(kSafe)
